...
namespace BlandAI
{
    public partial class NumbersClient
    {
        ...
        private static readonly global::BlandAI.EndPointSecurityRequirement s_PurchaseNumberSecurityRequirement0 =
        ...
        private static readonly global::BlandAI.EndPointSecurityRequirement[] s_PurchaseNumberSecurityRequirements =
            new global::BlandAI.EndPointSecurityRequirement[]
            {                s_PurchaseNumberSecurityRequirement0,
            };
        partial void PreparePurchaseNumberArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::BlandAI.PurchaseNumberRequest request);
        partial void PreparePurchaseNumberRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::BlandAI.PurchaseNumberRequest request);
        partial void ProcessPurchaseNumberResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessPurchaseNumberResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlandAI.StatusResponse> PurchaseNumberAsync(

            global::BlandAI.PurchaseNumberRequest request,
            global::BlandAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await PurchaseNumberAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlandAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlandAI.AutoSDKHttpResponse<global::BlandAI.StatusResponse>> PurchaseNumberAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PreparePurchaseNumberArguments(
            ...
            var __authorizations = global::BlandAI.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_PurchaseNumberSecurityRequirements,
                operationName: "PurchaseNumberAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlandAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlandAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "PurchaseNumberAsync",
                                pathTemplate: "\"/numbers/purchase\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::BlandAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessPurchaseNumberResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlandAI.StatusResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlandAI.AutoSDKHttpResponse<global::BlandAI.StatusResponse>(
                                ...
                                {
                                    throw global::BlandAI.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlandAI.StatusResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await PurchaseNumberAsync(
                request: __request,
                requestOptions: requestOptions,
