...
namespace BlandAI
{
    public partial class AccountClient
    {
        ...
        private static readonly global::BlandAI.EndPointSecurityRequirement s_GetAccountDetailsSecurityRequirement0 =
        ...
        private static readonly global::BlandAI.EndPointSecurityRequirement[] s_GetAccountDetailsSecurityRequirements =
            new global::BlandAI.EndPointSecurityRequirement[]
            {                s_GetAccountDetailsSecurityRequirement0,
            };
        partial void PrepareGetAccountDetailsArguments(
            global::System.Net.Http.HttpClient httpClient);
        partial void PrepareGetAccountDetailsRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage);
        partial void ProcessGetAccountDetailsResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetAccountDetailsResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::BlandAI.AccountDetails> GetAccountDetailsAsync(
            global::BlandAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetAccountDetailsAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlandAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlandAI.AutoSDKHttpResponse<global::BlandAI.AccountDetails>> GetAccountDetailsAsResponseAsync(
            global::BlandAI.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetAccountDetailsArguments(
                httpClient: HttpClient);


            var __authorizations = global::BlandAI.EndPointSecurityResolver.ResolveAuthorizations(
                availableAuthorizations: Authorizations,
                securityRequirements: s_GetAccountDetailsSecurityRequirements,
                operationName: "GetAccountDetailsAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetAccountDetailsRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::BlandAI.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::BlandAI.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetAccountDetailsAsync",
                                pathTemplate: "\"/v1/me\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetAccountDetailsResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::BlandAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetAccountDetailsResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlandAI.AccountDetails.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlandAI.AutoSDKHttpResponse<global::BlandAI.AccountDetails>(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlandAI.AccountDetails.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
