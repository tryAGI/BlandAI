...
namespace BlandAI
{
    public partial class CallsClient
    {
        ...
        public async global::System.Threading.Tasks.Task<global::BlandAI.SendCallResponse> SendCallAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::BlandAI.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::BlandAI.AutoSDKHttpResponse<global::BlandAI.SendCallResponse>> SendCallAsResponseAsync(
                ...
                else
                {
                    await global::BlandAI.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                global::BlandAI.ErrorResponse? __value_400 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_400 = global::BlandAI.ErrorResponse.FromJson(__content_400, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_400 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw global::BlandAI.ApiException<global::BlandAI.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::BlandAI.SendCallResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::BlandAI.AutoSDKHttpResponse<global::BlandAI.SendCallResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::BlandAI.SendCallResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::BlandAI.SendCallResponse> SendCallAsync(
            ...
            global::BlandAI.SendCallRequestModel? model = default,
            ...
            global::BlandAI.SendCallRequestBackgroundTrack? backgroundTrack = default,
            bool? noiseCancellation = default,
            bool? blockInterruptions = default,
            bool? record = default,
            global::BlandAI.VoicemailConfig? voicemail = default,
            global::System.Collections.Generic.IList<global::BlandAI.SendCallRequestPronunciationGuideItem>? pronunciationGuide = default,
            global::System.Collections.Generic.IList<string>? keywords = default,
            string? webhook = default,
            global::System.Collections.Generic.IList<global::BlandAI.SendCallRequestWebhookEvent>? webhookEvents = default,
