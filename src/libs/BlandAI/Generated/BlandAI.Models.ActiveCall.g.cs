...
namespace BlandAI
{
    ...
    public sealed partial class ActiveCall
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::BlandAI.JsonConverters.ActiveCallStatusJsonConverter))]
        public global::BlandAI.ActiveCallStatus? Status { get; set; }
        ...
        public ActiveCall(
            ...
            global::BlandAI.ActiveCallStatus? status,
            string? timestamp)
        {
            this.CallId = callId;
            this.UserId = userId;
