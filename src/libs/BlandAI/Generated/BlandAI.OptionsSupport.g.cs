...
namespace BlandAI
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::BlandAI.AutoSDKRetryOptions Retry { get; set; } = new global::BlandAI.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::BlandAI.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::BlandAI.IAutoSDKHook>();
        ...
        public global::BlandAI.AutoSDKClientOptions AddHook(
            global::BlandAI.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::BlandAI.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::BlandAI.AutoSDKClientOptions UseAuthorizationProvider(
            global::BlandAI.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::BlandAI.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::BlandAI.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::BlandAI.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::BlandAI.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::BlandAI.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::BlandAI.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::BlandAI.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::BlandAI.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::BlandAI.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::BlandAI.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::BlandAI.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::BlandAI.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::BlandAI.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::BlandAI.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::BlandAI.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::BlandAI.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::BlandAI.AutoSDKClientOptions clientOptions,
            global::BlandAI.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::BlandAI.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::BlandAI.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::BlandAI.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::BlandAI.AutoSDKClientOptions clientOptions,
            global::System.Func<global::BlandAI.IAutoSDKHook, global::BlandAI.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::BlandAI.AutoSDKHookContext context)
        {
